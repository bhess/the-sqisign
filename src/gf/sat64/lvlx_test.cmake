...
target_include_directories(sqisign_test_gf_${SVARIANT_LOWER}_fp PRIVATE ${INC_GF} ${INC_MP} ${INC_GF_${SVARIANT_UPPER}} ${INC_COMMON} ${PROJECT_SOURCE_DIR}/src/precomp/ref/${SVARIANT_LOWER}/include ${INC_PUBLIC})
...
target_include_directories(sqisign_test_gf_${SVARIANT_LOWER}_fp2 PRIVATE ${INC_GF} ${INC_MP} ${INC_GF_${SVARIANT_UPPER}} ${INC_COMMON} ${PROJECT_SOURCE_DIR}/src/precomp/ref/${SVARIANT_LOWER}/include ${INC_PUBLIC})
...
target_include_directories(sqisign_bench_gf_${SVARIANT_LOWER}_fp PRIVATE ${INC_GF} ${INC_MP} ${INC_GF_${SVARIANT_UPPER}} ${INC_COMMON} ${PROJECT_SOURCE_DIR}/src/precomp/ref/${SVARIANT_LOWER}/include ${INC_PUBLIC})
...
target_include_directories(sqisign_bench_gf_${SVARIANT_LOWER}_fp2 PRIVATE ${INC_GF} ${INC_MP} ${INC_GF_${SVARIANT_UPPER}} ${INC_COMMON} ${PROJECT_SOURCE_DIR}/src/precomp/ref/${SVARIANT_LOWER}/include ${INC_PUBLIC})
