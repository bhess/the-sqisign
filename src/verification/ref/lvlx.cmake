set(SOURCE_FILES_VERIFICATION_GENERIC_REF
    ${LVLX_DIR}/common.c
    ${LVLX_DIR}/encode_public.c
    ${LVLX_DIR}/verify.c
)

add_library(${LIB_VERIFICATION_${SVARIANT_UPPER}} STATIC ${SOURCE_FILES_VERIFICATION_GENERIC_REF})
target_link_libraries(${LIB_VERIFICATION_${SVARIANT_UPPER}} ${LIB_PRECOMP_${SVARIANT_UPPER}} ${LIB_MP_${SVARIANT_UPPER}} ${LIB_GF_${SVARIANT_UPPER}} ${LIB_EC_${SVARIANT_UPPER}} ${LIB_HD_${SVARIANT_UPPER}})
