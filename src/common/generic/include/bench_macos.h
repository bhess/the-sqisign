...
macos_init_rdtsc()
{
    ...
    kpep_event *ev_arr[sizeof(profile_events) / sizeof(profile_events[0])] = { 0 };
...
macos_rdtsc(void)
{
    u64 g_counters[KPC_MAX_COUNTERS] = { 0 };

    if (kpc_get_thread_counters(0, KPC_MAX_COUNTERS, g_counters)) {
