...
from parameters import p, f, security_bits
...
with open("include/ec_params.h", "w") as hfile:
    with open("ec_params.c", "w") as cfile:
        ...
        hfile.write(f'#define CHALLENGE_POWER {security_bits}\n')
        hfile.write('\n')
        ...
        hfile.write(f'#define EC_EXTRA_TORSION {2}\n')
        hfile.write(f'#define HD_EXTRA_TORSION {2}\n')
        hfile.write('\n')
        cfile.write('\n')
